...
neural_man = PipelineManager(dataset, neural_struct, 'skill_manager', add_watcher=False)
neural_man.run()

linear_man = PipelineManager(dataset, linear_struct, 'skill_manager', add_watcher=False)
linear_man.run()
